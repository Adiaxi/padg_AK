...
class Login:
    ...
    def build_login(self):
        ...
        self.pswd_button = ctk.CTkButton(self.log_frame, text="See", font=("Segoe UI", 12, "bold"), width=40,
                                         command=self.pswd)
...
class AppView:
    def __init__(self, parent):
        ...
        self.bank_frame = ctk.CTkFrame(self.side_bar_frame, corner_radius=20, fg_color="#2F3A40", border_width=3,
                                       border_color="#4B5A5E")
        ...
        self.worker_frame = ctk.CTkFrame(self.side_bar_frame, corner_radius=20, fg_color="#2F3A40", border_width=3,
                                         border_color="#4B5A5E")
    ...
    def build_bank_list_frame(self):
        ...
        self.bank_label = ctk.CTkLabel(self.bank_header, text='Banks', font=('Montserrat', 24, 'bold'),
                                       fg_color="#2F3A40")
        self.bank_label.grid(row=0, column=0, padx=10)
        self.bank_search = ctk.CTkEntry(self.bank_header, placeholder_text="Search Bank",
                                        font=("Montserrat", 14, "bold"))
        self.bank_search.grid(row=0, column=1, padx=(30, 2))
        self.bank_search_btn = ctk.CTkButton(self.bank_header, text='Go', width=25, height=25,
                                             font=('Montserrat', 18, 'bold'), fg_color="#0EA5A4", hover_color="#14B8A6",
                                             command=lambda: self.filter_banks())
        ...
        self.bank_add_btn = ctk.CTkButton(self.bank_frame, text="Add Bank", font=("Montserrat", 14, "bold"), width=130,
                                          fg_color="#2563EB", hover_color="#3B82F6",
                                          command=lambda: self.build_bank_form_window())
        self.bank_add_btn.grid(row=2, column=0, padx=10, pady=15)
        self.bank_details_btn = ctk.CTkButton(self.bank_frame, text="Details", font=("Montserrat", 14, "bold"),
                                              width=140, fg_color='#37474F', hover_color="#455A64",
                                              command=lambda: self.build_bank_details_window())
        self.bank_details_btn.grid(row=2, column=1, padx=10, pady=15)
        self.bank_edit_btn = ctk.CTkButton(self.bank_frame, text="Edit", font=("Montserrat", 14, "bold"), width=140,
                                           fg_color='#D97706', hover_color="#F59E0B",
                                           command=lambda: self.build_bank_form_edit_window())
    ...
    def bank_info(self):
        ...
        for bank in banks:
            ...
            bk = ctk.CTkLabel(self.row, font=("Montserrat", 15, "bold"), text=(f"{bank.name}"), anchor="w",
                              justify="left")
            bk.pack(side='left', fill='x', expand=True, padx=10)
            bk.bind("<Button-1>", lambda e, b=bank, l=bk: self.select_bank(b, l))

            btn = ctk.CTkButton(self.row, text="X", font=("Montserrat", 11, "bold"), width=50,
                                command=lambda temp=bank: (delete_bank(temp), self.bank_info()), fg_color="#B91C1C",
                                hover_color="#DC2626")
    ...
    def build_bank_form_edit_window(self):
        ...
        self.head = ctk.CTkLabel(self.window_form_frame, text="Edit Bank", font=('Montserrat', 25, "bold")).grid(row=0,
                                                                                                                 column=0,
                                                                                                                 columnspan=2,
                                                                                                                 pady=(
                                                                                                                     10,
        ...
        for i, text in enumerate(labels, start=1):
            ctk.CTkLabel(self.window_form_frame, text=text, font=('Montserrat', 18, "bold"), anchor="w").grid(row=i,
                                                                                                              column=0,
                                                                                                              padx=(15,
                                                                                                                    5),
                                                                                                              pady=5,
        ...
        self.button_bank_save = ctk.CTkButton(self.window_form_frame, text="Save", font=('Montserrat', 20, "bold"),
                                              width=120, height=35, command=lambda: (
                self.selected_bank.update(self.entry_bank_name.get(), self.entry_bank_town.get(),
                                          self.entry_bank_street.get(), self.entry_bank_number.get(),
                                          self.entry_bank_logo.get()), self.bank_entry_clear(), self.bank_info()))
    ...
    def build_bank_form_window(self):
        ...
        self.window_form_frame.grid(row=0, column=0, padx=15, pady=15, sticky='nsew')
        self.window_form_frame.grid_columnconfigure(1, weight=1)
        self.head = ctk.CTkLabel(self.window_form_frame, text="Add Bank", font=('Montserrat', 25, "bold")).grid(row=0,
                                                                                                                column=0,
                                                                                                                columnspan=2,
                                                                                                                pady=(
                                                                                                                    10,
        ...
        self.button_bank_save = ctk.CTkButton(self.window_form_frame, text="Save", font=('Montserrat', 20, "bold"),
                                              width=120, height=35, command=lambda: (
                add_bank(self.entry_bank_name.get(), self.entry_bank_town.get(), self.entry_bank_street.get(),
                         self.entry_bank_number.get(), self.entry_bank_logo.get()), self.bank_entry_clear(),
                self.bank_info()))
        self.button_bank_save.grid(row=6, column=0, columnspan=2, padx=30, pady=25, sticky="nsew")
    ...
    def build_bank_details_window(self):
        ...
        self.details_header_lbl = ctk.CTkLabel(self.bank_details_header, text=f"{self.selected_bank.name}",
        ...
        for i in range(len(t)):
            ctk.CTkLabel(self.bank_details_body, text=tt[i], font=('Montserrat', 14), text_color="#CBD5E1").grid(
                row=i + 1, column=0, padx=(20, 0), sticky="w")
            ctk.CTkLabel(self.bank_details_body, text=f"{t[i]}", font=('Montserrat', 16, "bold"),
                         text_color="white").grid(row=i + 1, column=1, padx=(0, 20), sticky="e")
    ...
    def build_workers_list_frame(self):
        ...
        self.worker_label = ctk.CTkLabel(self.worker_header, text='Workers', font=('Montserrat', 24, 'bold'),
                                         fg_color="#2F3A40")
        self.worker_label.grid(row=0, column=0, padx=10)
        self.worker_search = ctk.CTkEntry(self.worker_header, placeholder_text="Search Worker",
                                          font=("Montserrat", 14, "bold"))
        self.worker_search.grid(row=0, column=1, padx=(30, 2))
        self.worker_search_btn = ctk.CTkButton(self.worker_header, text='Go', width=25, height=25,
                                               font=('Montserrat', 18, 'bold'), fg_color="#0EA5A4",
                                               hover_color="#14B8A6", command=lambda: self.filter_workers())
        ...
        self.worker_add_btn = ctk.CTkButton(self.worker_frame, text="Add Worker", font=("Montserrat", 14, "bold"),
                                            width=130, fg_color="#2563EB", hover_color="#3B82F6",
                                            command=lambda: self.build_worker_form())
        self.worker_add_btn.grid(row=2, column=0, padx=10, pady=15)
        self.worker_details_btn = ctk.CTkButton(self.worker_frame, text="Details", font=("Montserrat", 14, "bold"),
                                                width=140, fg_color='#37474F', hover_color="#455A64",
                                                command=lambda: self.build_worker_details_window())
        self.worker_details_btn.grid(row=2, column=1, padx=10, pady=15)
        self.worker_edit_btn = ctk.CTkButton(self.worker_frame, text="Edit", font=("Montserrat", 14, "bold"), width=140,
                                             fg_color='#D97706', hover_color="#F59E0B",
                                             command=lambda: self.build_worker_form_edit_window())
    ...
    def build_worker_form_edit_window(self):
        ...
        self.w_root.title("Add")
        self.w_root.configure(fg_color="#69797D")
        self.w_root.geometry("500x550")
        self.w_root.grid_rowconfigure(0, weight=1)
        self.w_root.grid_columnconfigure(0, weight=1)
        self.window_form_frame = ctk.CTkFrame(self.w_root, corner_radius=12)
        self.window_form_frame.grid(row=0, column=0, padx=15, pady=15, sticky='nsew')
        self.window_form_frame.grid_columnconfigure(1, weight=1)
        self.head = ctk.CTkLabel(self.window_form_frame, text="Edit Worker", font=('Montserrat', 25, "bold")).grid(
            row=0, column=0, columnspan=2, pady=(10, 15))
        labels = ["Name", "Surname", "Bank", "Role", "Town", "Street", "Home Number", "Photo", "Login", "Password"]
        for i, text in enumerate(labels, start=1):
            ctk.CTkLabel(self.window_form_frame, text=text, font=('Montserrat', 18, "bold"), anchor="w").grid(row=i,
                                                                                                              column=0,
                                                                                                              padx=(15,
        ...
        self.entry_worker_login = ctk.CTkEntry(self.window_form_frame)
        self.entry_worker_login.insert(0, self.selected_worker.login)
        ...
        self.button_worker_save = ctk.CTkButton(self.window_form_frame, text="Save", font=('Montserrat', 20, "bold"),
                                                width=120, height=35, command=lambda: (
                add_worker(self.entry_worker_name.get(), self.entry_worker_surname.get(),
                           next(b for b in banks if b.name == self.bank_var.get()), self.entry_worker_role.get(),
                           self.entry_worker_town.get(), self.entry_worker_street.get(), self.entry_worker_number.get(),
                           self.entry_worker_photo.get(), self.entry_worker_login.get(),
                           self.entry_worker_password.get()), self.worker_entry_clear(), self.worker_info()))
        self.button_worker_save.grid(row=11, column=0, columnspan=2, padx=30, pady=25, sticky="nsew")
    ...
    def build_worker_form(self):
        ...
        self.window_form_frame.grid(row=0, column=0, padx=15, pady=15, sticky='nsew')
        self.window_form_frame.grid_columnconfigure(1, weight=1)
        self.head = ctk.CTkLabel(self.window_form_frame, text="Add Worker", font=('Montserrat', 25, "bold")).grid(row=0,
                                                                                                                  column=0,
                                                                                                                  columnspan=2,
                                                                                                                  pady=(
                                                                                                                      10,
                                                                                                                      15))
        labels = ["Name", "Surname", "Bank ID", "Role", "Town", "Street", "Home Number", "Photo", "Login", "Password"]
        for i, text in enumerate(labels, start=1):
            ctk.CTkLabel(self.window_form_frame, text=text, font=('Montserrat', 18, "bold"), anchor="w").grid(row=i,
                                                                                                              column=0,
                                                                                                              padx=(15,
    ...
    def worker_info(self):
        ...
        for worker in workers:
            ...
            wr = ctk.CTkLabel(self.row, font=("Montserrat", 15, "bold"), text=(f"{worker.name}, {worker.surname}"),
                              anchor="w", justify="left")
            wr.pack(side='left', fill='x', expand=True, padx=10)
            wr.bind("<Button-1>", lambda e, w=worker, l=wr: self.select_worker(w, l))

            btn = ctk.CTkButton(self.row, text="X", font=("Montserrat", 11, "bold"), width=50,
                                command=lambda temp=worker: (delete_worker(temp), self.worker_info()),
    ...
    def build_worker_details_window(self):
        ...
        t = [
            ...
            self.selected_worker.login
        ]
        tt = ["Role", "Bank", "City", "Street", "Number", "Login"]
        for i in range(len(t)):
            ctk.CTkLabel(
                self.worker_details_body,
                text=tt[i],
    ...
    def build_user_window_button_frame(self):
        self.user_window_button = ctk.CTkButton(self.user_window_button_frame, text="Bank Users",
                                                font=("Montserrat", 18, "bold"), width=140, fg_color="#6366F1",
                                                hover_color="#818CF8", corner_radius=10,
                                                command=lambda: self.build_user_window())
    ...
    def build_user_window(self):
        ...
        self.w_root.grid_rowconfigure(0, weight=1)
        self.w_root.grid_columnconfigure(0, weight=1)
        self.user_frame = ctk.CTkFrame(self.w_root, corner_radius=20, fg_color="#2F3A40", border_width=3,
                                       border_color="#4B5A5E")
        ...
        self.user_label = ctk.CTkLabel(self.user_header, text='Users', font=('Montserrat', 24, 'bold'),
                                       fg_color="transparent")
        self.user_label.grid(row=0, column=0, padx=10)
        self.user_search = ctk.CTkEntry(self.user_header, placeholder_text="Search User",
                                        font=("Montserrat", 14, "bold"))
        ...
        self.user_add_btn = ctk.CTkButton(self.user_frame, text="Add User", font=("Montserrat", 14, "bold"), width=130,
                                          fg_color="#2563EB", hover_color="#3B82F6",
                                          command=lambda: self.build_user_form())
        self.user_add_btn.grid(row=2, column=0, padx=10, pady=15)
        self.user_details_btn = ctk.CTkButton(self.user_frame, text="Details", font=("Montserrat", 14, "bold"),
                                              width=140, fg_color='#37474F', hover_color="#455A64",
                                              command=lambda: self.build_user_details_window())
        self.user_details_btn.grid(row=2, column=1, padx=10, pady=15)
        self.user_edit_btn = ctk.CTkButton(self.user_frame, text="Edit", font=("Montserrat", 14, "bold"), width=140,
                                           fg_color='#D97706', hover_color="#F59E0B",
                                           command=lambda: self.build_user_edit_form())
    ...
    def build_user_form(self):
        self.u_root = ctk.CTkToplevel(self.root)
        self.u_root.transient(self.root)
        ...
        self.window_form_frame.grid(row=0, column=0, padx=15, pady=15, sticky='nsew')
        self.window_form_frame.grid_columnconfigure(1, weight=1)
        self.head = ctk.CTkLabel(self.window_form_frame, text="Add user", font=('Montserrat', 25, "bold")).grid(row=0,
                                                                                                                column=0,
                                                                                                                columnspan=2,
                                                                                                                pady=(
                                                                                                                    10,
        ...
        for i, entry in enumerate(entries, start=1):
            entry.grid(row=i, column=1, padx=15, pady=5, sticky='nsew')
        self.button_user_save = ctk.CTkButton(self.window_form_frame, text="Save", font=('Montserrat', 20, "bold"),
                                              width=120, height=35, command=lambda: (
                add_user(self.entry_user_name.get(), self.entry_user_surname.get(),
                         next(b for b in banks if b.name == self.bank_var.get()), self.entry_user_town.get(),
                         self.entry_user_street.get(), self.entry_user_home_number.get(), self.entry_user_email.get(),
                         self.entry_user_phone.get(), self.entry_user_password.get(),
                         self.entry_user_balance.get() or 0), self.user_entry_clear(), self.user_info()))
        self.button_user_save.grid(row=11, column=0, columnspan=2, padx=30, pady=25, sticky="nsew")

    def build_user_edit_form(self):
        self.u_root = ctk.CTkToplevel(self.w_root)
        self.u_root.transient(self.w_root)
        self.u_root.title("Edit")
        self.u_root.configure(fg_color="#69797D")
        self.u_root.geometry("400x550")
        self.u_root.grid_rowconfigure(0, weight=1)
        self.u_root.grid_columnconfigure(0, weight=1)
        ...
        self.window_form_frame.grid(row=0, column=0, padx=15, pady=15, sticky='nsew')
        self.window_form_frame.grid_columnconfigure(1, weight=1)
        self.head = ctk.CTkLabel(self.window_form_frame, text="Edit user", font=('Montserrat', 25, "bold")).grid(row=0,
                                                                                                                 column=0,
                                                                                                                 columnspan=2,
                                                                                                                 pady=(
                                                                                                                     10,
        ...
        for i, text in enumerate(labels, start=1):
            ctk.CTkLabel(self.window_form_frame, text=text, font=('Montserrat', 18, "bold"), anchor="w").grid(row=i,
                                                                                                              ...
                                                                                                              sticky='w')
        self.entry_user_name = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_name.insert(0, self.selected_user.name)
        self.entry_user_surname = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_surname.insert(0, self.selected_user.surname)
        self.bank_var = ctk.StringVar(value=banks[0].name)
        self.entry_user_bank = ctk.CTkOptionMenu(
            self.window_form_frame,
            variable=self.bank_var,
        ...
        self.bank_var.set(self.selected_user.bank.name)
        self.entry_user_town = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_town.insert(0, self.selected_user.town)
        self.entry_user_phone = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_phone.insert(0, self.selected_user.phone)
        self.entry_user_street = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_street.insert(0, self.selected_user.street)
        self.entry_user_home_number = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_home_number.insert(0, self.selected_user.home_number)
        self.entry_user_email = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_email.insert(0, self.selected_user.email)
        self.entry_user_phone = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_phone.insert(0, self.selected_user.phone)
        self.entry_user_password = ctk.CTkEntry(self.window_form_frame)
        self.entry_user_balance = ctk.CTkEntry(self.window_form_frame)
    ...
    def user_info(self):
        ...
        for user in users:
            ...
            us = ctk.CTkLabel(self.row, font=("Montserrat", 15, "bold"), text=(f"{user.name}, {user.surname}"),
                              anchor="w", justify="left")
            us.pack(side='left', fill='x', expand=True, padx=10)
            us.bind("<Button-1>", lambda e, u=user, l=us: self.select_user(u, l))

            btn = ctk.CTkButton(self.row, text="X", font=("Montserrat", 11, "bold"), width=50,
                                command=lambda temp=user: (delete_user(temp), self.user_info()), fg_color="#B91C1C",
                                hover_color="#DC2626")
            btn.pack(side='right', padx=10)
            btn.pack(side='right', padx=10)
    ...
    def build_user_details_window(self):
        ...
        lat, lon = self.selected_user.coords
        self.map_widget.set_position(lat, lon)
        self.map_widget.set_zoom(15)

        self.d_root = ctk.CTkToplevel(self.root)
        self.d_root.transient(self.root)
        self.d_root.lift()
        self.d_root.focus_force()
        self.d_root.title("User Details")
        self.d_root.geometry("400x350")
        self.d_root.configure(fg_color="#69797D")
        self.d_root.grid_rowconfigure(0, weight=1)
        self.d_root.grid_rowconfigure(1, weight=4)
        self.d_root.grid_columnconfigure(0, weight=1)

        self.user_details_header = ctk.CTkFrame(self.d_root, corner_radius=12)
        ...
        self.user_details_body = ctk.CTkFrame(self.d_root, corner_radius=12)
    ...
    def build_search_button(self):
        self.address_search_entry = ctk.CTkEntry(self.map_frame, font=("Segoe UI", 12, "bold"), width=250,
                                                 placeholder_text="Enter Address")
        self.address_button_search = ctk.CTkButton(self.map_frame, text="Search", font=("Segoe UI", 12, "bold"),
                                                   width=60, fg_color="#7C3AED", hover_color="#8B5CF6",
                                                   command=lambda: self.zoom_to())
    ...
    def build_button_unzoom(self):
        self.unzoom_button = ctk.CTkButton(self.map_frame, text=" - ", font=("Segoe UI", 12, "bold"), width=30,
                                           fg_color="#37474F", hover_color="#455A64", command=lambda: self.unzoom_to())
